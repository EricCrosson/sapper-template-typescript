...
const posts = [
...

  {
    ...
    slug: 'typescript',
    html: `
      <p>Typescript is a typed superscript of javascript that compiles to plain javascript. This project uses Typescript to provide type safety to javascript development in the sapper framework.</p>
    `
  }
];
